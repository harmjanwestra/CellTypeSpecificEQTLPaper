...
//                    }
    ...
    public void runIterativeNormalizer(String f,
            ...
            Integer threads,
            String outdirectory) throws IOException, Exception {
...
// EGCUT,SHIP_TREND,Groningen-HT12,-,Rotterdam,DILGOM,INCHIANTI,HVH-HT12v3,-
    ...
    private void merge(String normal1, String robust1, String normal2, String robust2, String out) throws IOException {
    ...
    private HashMap<String, Double> loadSE(String file) throws IOException {
    ...
    private void spearmanSE(String normal1, String robust1) throws IOException {
        HashMap<String, Double> eQTLToSE = loadSE(normal1);
        HashMap<String, Double> eQTLToSERobust = loadSE(robust1);
